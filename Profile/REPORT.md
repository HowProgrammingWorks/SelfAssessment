...
| &nbsp;&nbsp;&nbsp;&nbsp; Functions | `10` | `10` |
| &nbsp;&nbsp;&nbsp;&nbsp; Data structures | `7` | `7` |
| &nbsp;&nbsp;&nbsp;&nbsp; Standard classes and namespaces u | `11` | `14` |
| &nbsp;&nbsp;&nbsp;&nbsp; Infrastructure | `6` | `6` |
...
| &nbsp;&nbsp;&nbsp;&nbsp; JavaScript & Node.js specific | `15` | `17` |
| &nbsp;&nbsp;&nbsp;&nbsp; Techniques | `7` | `10` |
...
Total: you have `70` of `72` skills, `2` to be upgraded, and `65` above needed
...
Total: you have `89` of `97` skills, `8` to be upgraded, and `70` above needed
...
Total: you have `49` of `50` skills, `1` to be upgraded, and `19` above needed

| To start Node.js | actual | ⟶  | required |
| --- | --- | --- | --- |
| Revealing constructor | 🤷 unknown | ⟶  | 👂 heard |

Total: you have `36` of `37` skills, `1` to be upgraded, and `20` above needed
